...
RSpec.describe "Admin Dashboard", type: :feature do
  describe "User Story #19 - When I visit the Admin Dashboard" do
    before :each do
    ...
    it "displays the names of top 5 customers with successful purchases" do
      ...
      #in the controller, call @top_5_cust = Customer.top_5_customers

      #in the view, call @top_5_cust.each_with_index do |customer, i|
      # <%= ("#{i}. #{customer.full_name} - #{customer.purchases} purchases"
